...
public class productModel {
	...
	public productModel(String productName, String productDescription, float productPrice, int productDiscount,
	...
	public productModel(int productId, String productName, float productPrice, int productDiscount, int productQunatity) {
		super();
		this.productId = productId;
		this.productName = productName;
		this.productPrice = productPrice;
