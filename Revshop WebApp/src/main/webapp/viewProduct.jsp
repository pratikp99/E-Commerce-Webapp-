...
<style type="text/css">
    ...
    .product-image {
        width: 100%;
        max-width: 600px; /* Fixed width or max width for the image container */
        margin-bottom: 20px;
        ...
        <div class="product-info">
            ...
            <div class="product-details">
                ...
                <p><b>Status:</b> <span id="availability">
                    <%=product.getProductQunatity() > 0 ? "Available" : "Currently Out of stock"%>
                </span></p>
                ...
                <div class="btn-group text-center mt-3">
                    ...
                    <% } else { %>
                        <form action="./addtocart" method="post">
                            ...
                            <button type="submit" class="btn btn-primary btn-custom btn-primary-custom">Add to Cart</button>
                        </form>
