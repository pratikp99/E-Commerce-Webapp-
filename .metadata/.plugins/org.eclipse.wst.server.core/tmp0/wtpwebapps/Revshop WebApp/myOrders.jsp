...
Map<Integer, List<orderedProductModel>> orderedProductsMap = (Map<Integer, List<orderedProductModel>>) request.getAttribute("orderedProductsMap");
%>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					for (orderModel order : orderList) {
						List<orderedProductModel> ordProdList = orderedProductsMap.get(order.getId());
